...
<html lang="zxx">
  <head>
    <title>SD ISLAM AL FIRDAUS MAGELANG</title>
    <!--meta tags -->
  ...
  <body>
    <!--headder-->
    <div class="header-outs inner_page-banner " id="home" style="background: url(images/hal.jpeg) no-repeat center;background-size: cover;">
