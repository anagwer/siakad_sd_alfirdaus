...
<head>
  ...
  <link rel="icon" href="../../home/images/sdislam.png" type="image/x-icon">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>SD Islam Al Firdaus Magelang</b></span>
    </a>
  ...
  <aside class="main-sidebar">
   ...
   <li class="treeview">
        ...
        <li><a href="?a=guru"><i class="fa fa-book"></i> <span>Data Guru</span></a></li>      
        <li><a href="?a=kelas"><i class="fa fa-book"></i> <span>Kelas</span></a></li>      
        ...
        <li><a href="?a=tahun_ajaran"><i class="fa fa-book"></i> <span>Tahun Ajaran</span></a></li>      
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="?a=SPP"><i class="fa fa-circle-o"></i> SPP</a></li>
            <li><a href="?a=Tabungan"><i class="fa fa-circle-o"></i> Tabungan</a></li>
          </ul>
        </li>
        ...
        <li><a href="?a=presensi"><i class="fa fa-calendar-check-o"></i> <span>Presensi Siswa</span></a></li> 
        <li><a href="?a=penilaianakhir"><i class="fa fa-file-powerpoint-o"></i> <span>Penilaian Ulangan UTS/UAS</span></a></li>  
        <li class="treeview">
          <a href="#">
            <i class="fa fa-money"></i>
            <span>Pembayaran</span>
